(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".smart__slider")) new core(".smart__slider", {
 ...
 */
                ...
                var e = {
                    ...
                    4713: function(e, t, i) {
                        ...
                        function d(e, t, i) {
                            ...
                            if (e > -1) {
                                ...
                                for (var w = v.shift(); w < p.length; w++) if (y(p[w], v, [ w ]) && h === e || h > e) break;
                            }
                    ...
                    7215: function(e, t, i) {
                        ...
                        function h(e, t, i) {
                            ...
                            for (var l = e; l < t; l++) if (void 0 === o.validPositions[l] && !r.isMask.call(n, l, !1)) if (0 == l ? a.getTest.call(n, l) : o.validPositions[l - 1]) {
        ...
        document.querySelector(".item-catalog__content");
        document.querySelector(".list-catalog_unactive");
        let inputs = document.querySelectorAll('input[type="tel"]');
        let im = new Inputmask("+7 (999) 999-99-99");
        im.mask(inputs);
        const scrollBtn = document.querySelector(".isShowBtn");
        window.onscroll = () => {
            if (window.scrollY > 1600) scrollBtn.classList.remove("isShowBtn_hide"); else if (window.scrollY < 1600) scrollBtn.classList.add("isShowBtn_hide");
        };
        scrollBtn.onclick = () => {
            window.scrollTo(0, 0);
        };
